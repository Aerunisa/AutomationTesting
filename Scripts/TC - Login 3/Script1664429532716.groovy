...
WebUI.click(findTestObject('Object Repository/Page_Facebook  log in or sign up/button_Yes, Continue'))

WebUI.setText(findTestObject('Object Repository/Page_Log in to Facebook/input_Log in to Facebook_email'), '123456@gmail.com')
